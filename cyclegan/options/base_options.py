...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default='', help='json path to images')
        parser.add_argument('--name', type=str, default='exper1', help='name of the experiment. It decides where to store samples and models')
